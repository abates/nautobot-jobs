...
def pylint(context):
    ...
    command = 'pylint --init-hook "import nautobot; nautobot.setup()" --rcfile pyproject.toml jobs'
    run_command(context, command)
...
def unittest(
    ...
    run_command(context, command)
    run_command(context, "coverage lcov -o lcov.info --include 'jobs/*'")


@task
def unittest_coverage(context):
    """Report on code test coverage as measured by 'invoke unittest'."""
    command = "coverage report --skip-covered --include 'jobs/*' --omit *migrations*"
